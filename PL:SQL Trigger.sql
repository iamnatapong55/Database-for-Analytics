...
DROP TRIGGER ResetNum;

CREATE OR REPLACE TRIGGER ResetNum
BEFORE INSERT OR UPDATE OF coursenr 
ON course
FOR EACH ROW
...
-- insert verification
insert into course values (1111, 'Theory of Computation II', 'CSC', 595);
insert into course values (2222, 'Cryptography II', 'CSC', 598);
insert into course values (3333, 'Cryptography III', 'CSC', 599);
insert into course values (4444, 'Data Analysis II', 'IT', 600);
-- update verification
update course set coursenr = 750 where cid = 2987;
